...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		// "store.txt"
		Scanner scanner = new Scanner(new File("/home/carrrina/Documents/test03/store.txt"));
		...
		scanner.close();
		// events.txt
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/carrrina/Documents/test03/output.txt"));
		String s;
		scanner = new Scanner(new File("/home/carrrina/Documents/test03/events.txt"));
